...
#
# Revision info: $Id: VirtualRedirect.pm,v 1.2 2006-11-30 19:57:11 diddledan Exp $
#
...
sub new {
	my ($class, $crimp) = @_;
	my $self = { id => q$Id: VirtualRedirect.pm,v 1.2 2006-11-30 19:57:11 diddledan Exp $, crimp => $crimp, };
	bless $self, $class;
}
