...
#
# Revision info: $Id: ContentDatabase.pm,v 1.4 2007-04-29 23:22:32 diddledan Exp $
#
...
sub new {
	my ($class, $crimp) = @_;
	my $self = { id => q$Id: ContentDatabase.pm,v 1.4 2007-04-29 23:22:32 diddledan Exp $, crimp => $crimp, };
	bless $self, $class;
}
