...
#
# Revision info: $Id: RandomContent.pm,v 1.1 2007-05-01 20:17:31 diddledan Exp $
#
...
sub new {
	my ($class, $crimp) = @_;
	my $self = { id => q$Id: RandomContent.pm,v 1.1 2007-05-01 20:17:31 diddledan Exp $, crimp => $crimp, };
	bless $self, $class;
}
