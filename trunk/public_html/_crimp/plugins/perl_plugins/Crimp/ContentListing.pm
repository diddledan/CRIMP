...
#
# Revision info: $Id: ContentListing.pm,v 1.3 2007-03-23 14:11:14 diddledan Exp $
#
...
sub new {
	my ($class, $crimp) = @_;
	my $self = { id => q$Id: ContentListing.pm,v 1.3 2007-03-23 14:11:14 diddledan Exp $, crimp => $crimp, };
	bless $self, $class;
}
