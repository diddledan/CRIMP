...
#
# Revision info: $Id: ContentDatabase.pm,v 1.1 2007-05-01 20:17:31 diddledan Exp $
#
...
sub new {
	my ($class, $crimp) = @_;
	my $self = { id => q$Id: ContentDatabase.pm,v 1.1 2007-05-01 20:17:31 diddledan Exp $, crimp => $crimp, };
	bless $self, $class;
}
